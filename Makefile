...
lib/lexer.wasm: src/lexer.h src/lexer.c
	...
	-Wl,-z,stack-size=16384,--no-entry,--compress-relocations,--strip-all,\
	--export=parse,--export=sa,--export=e,--export=ri,--export=re,--export=is,--export=ie,--export=ss,--export=se,--export=id,--export=es,--export=ee,--export=f,--export=__heap_base \
