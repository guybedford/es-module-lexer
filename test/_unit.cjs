...
suite('Lexer', () => {
  ...
  test(`The import path is incorrect`, () => {
    try {
      const source = `
      import * from 'D:\\c';
      import * from './b';
      ...
      assert.strictEqual(imports[0].ss, 7);
      assert.strictEqual(imports[0].se, 27);
      assert.strictEqual(imports[0].s, 22);
      assert.strictEqual(imports[0].e, 26);
      assert.strictEqual(imports[0].n, "D:\\c");

      assert.strictEqual(imports[1].ss, 35);
      assert.strictEqual(imports[1].se, 54);
      assert.strictEqual(imports[1].s, 50);
      assert.strictEqual(imports[1].e, 53);
      assert.strictEqual(imports[1].n, "./");
